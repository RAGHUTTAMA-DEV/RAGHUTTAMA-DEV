...
🎯 I specialize in **MERN Stack**, **TypeScript**, and **Next.js**, and have a growing skill set in **AI-integrated applications** and **real-time systems** using **WebSockets** and **WebRTC**.  
🛠️ I've built projects in healthcare, education, disaster response, and smart systems — always aiming for real-world impact.  
🌱 Currently deep-diving into **Next.js**, **PostgreSQL**, **Prisma**, and **AI-based solutions**.  
